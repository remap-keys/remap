      ...
      >
        ...
        <DialogContent dividers className="import-file-content">
          <KeyboardDefinitionFormPart
            messageHtml={`Please import <strong>${this.props.productName}</strong>'s definition file (<a href="https://caniusevia.com/docs/specification/" target="_blank" rel="referrer">.json</a>).`}
