                  ...
                  <div className="create-definition-form-container">
                    <div className="create-definition-upload-form">
                      <KeyboardDefinitionFormPart
                        messageHtml={`<span class="create-definition-upload-msg">Please import your file (<a href="https://caniusevia.com/docs/specification/" target="_blank" rel="referrer">.json</a>)</span>`}
