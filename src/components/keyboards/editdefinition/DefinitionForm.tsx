    ...
    <div className="edit-definition-form-container">
      ...
      <div className="edit-definition-form">
        ...
        <div className="edit-definition-form-notice">
          <p>
            * Only JSON files by the keyboards maintainer will be accepted (specified in the config.h). 
            Do NOT infringe on the rights of the original creator. 
            We will validate authorship of the keyboard you requested in our review process.
          </p>
          <p>
            * We will validate if your keyboard has a unique combination
